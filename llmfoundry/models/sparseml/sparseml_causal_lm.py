...
__all__ = ['ComposerSparseAutoModelCausalLM']

log = logging.getLogger(__name__)


class ComposerSparseAutoModelCausalLM(HuggingFaceModelWithFSDP):
    ...
    def __init__(
        ...
        model = ComposerSparseAutoModelCausalLM.build_inner_model(
        ...
        train_metrics, eval_metrics = ComposerSparseAutoModelCausalLM.build_metrics(
    ...
    def build_inner_model(
        ...
        """Builds the inner model for the ComposerSparseAutoModelCausalLM.
        ...
        if prepare_for_fsdp:
            ComposerSparseAutoModelCausalLM.prepare_inner_model(model, init_device)
        return model
